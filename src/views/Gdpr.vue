<template>
  <div class="gdpr">
    ...
    <div class="view">
      ...
      <p class="italic">Last updated: March 16, 2022</p>
      ...
      <ul>
        ...
        <li>
          ...
          "Our" in this Agreement) refers to Lídia's Gallery.
        </li>
        ...
        <li><b>Country</b> refers to: Hungary</li>
        ...
        <li>
          <b>Website</b> refers to Lídia's Gallery, accessible from
          https://blog.esoguides.hu
        </li>
      ...
      <p>
        ...
        Learn more about cookies: Cookies by PrivacyPolicies Generator.
      </p>
      ...
      <o
        ...
        legal agreements and policies.</o
      >
      ...
      <o
        ...
        data for longer time periods.</o
      >
      ...
      <ul>
        <li>By email: matika1974@gmail.com</li>
      </ul>
    </div>
  </div>
</template>
